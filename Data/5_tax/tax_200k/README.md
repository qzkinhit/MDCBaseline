...
1. **规则涉及**的属性中，保证**主键属性集合干净**的情况下，注入不同比例的混合错误。
   ...
   - **错误注入比例**：
     ...
     - **a. 0.25%**  
       ...
       - 非主键属性0.25%的空缺值
       - 非主键属性0.25%的异常值
       - **Original Error Count (OEC)** = 总错误单元格数 = 6494
       - **错误条目数** = 待填写
    ...
    - **b. 0.5%**  
      ...
      - 非主键属性 0.5% 的空缺值
      - 非主键属性 0.5% 的异常值
      - **Original Error Count (OEC)** = 总错误单元格数 = 12978
      - **错误条目数** = 待填写
    ...
    - **c. 0.75%**  
      ...
      - 非主键属性 0.75% 的空缺值
      - 非主键属性 0.75% 的异常值
      - **Original Error Count (OEC)** = 总错误单元格数 = 19333
      - **错误条目数** = 待填写
    ...
    - **d. 1%**  
      ...
      - 非主键属性 1% 的空缺值
      - 非主键属性 1% 的异常值
      - **Original Error Count (OEC)** = 总错误单元格数 = 25791
      - **错误条目数** = 待填写
    ...
    - **e. 1.25%**  
      ...
      - 非主键属性 1.25% 的空缺值
      - 非主键属性 1.25% 的异常值
      - **Original Error Count (OEC)** = 总错误单元格数 = 32480
      - **错误条目数** = 待填写
    ...
    - **f. 1.5%**  
      ...
      - 非主键属性 1.5% 的空缺值
      - 非主键属性 1.5% 的异常值
      - **Original Error Count (OEC)** = 总错误单元格数 = 38495
      - **错误条目数** = 待填写
    ...
    - **g. 1.75%**  
      ...
      - 非主键属性 1.75% 的空缺值
      - 非主键属性 1.75% 的异常值
      - **Original Error Count (OEC)** = 总错误单元格数 = 44975
      - **错误条目数** = 待填写
    ...
    - **h. 2%**  
      ...
      - 非主键属性 2% 的空缺值
      - 非主键属性 2% 的异常值
      - **Original Error Count (OEC)** = 总错误单元格数 = 51099
      - **错误条目数** = 待填写
