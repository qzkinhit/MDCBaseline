...
# 每个属性注入2%的错误比例
attributes_error_ratio = {attribute: 1 for attribute in attributes}

inject_missing_values(
    csv_file=r"C:\Users\lzfd\Desktop\work\MDCBaseline\Data\2_flights\noise_with_correct_primary_key\dirty_mix_1\dirty_flights.csv",
    output_file=r"C:\Users\lzfd\Desktop\work\MDCBaseline\Data\2_flights\noise_with_correct_primary_key\dirty_mix_1\dirty_flights_null.csv",
