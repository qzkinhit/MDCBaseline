...
# 读取干净数据子集和脏数据
clean_data_path = 'clean_index_10k.csv'
dirty_data_path = 'noise_with_correct_primary_key/dirty_mixed_0.25/dirty_soccer_mix_0.25.csv'
...
# 输出结果到文件
dirty_subset_path = 'noise_with_correct_primary_key/dirty_mixed_0.25/dirty_soccer_mix_0.25.csv'
