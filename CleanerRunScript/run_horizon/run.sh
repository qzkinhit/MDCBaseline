...
horizon_commands=(
    ...
    #"python3 CleanerRunScript/run_horizon/run_horizon_base.py --dirty_path Data/5_tax/subset_dirty_index_10k.csv --rule_path Data/5_tax/dc_rules-validate-fd-horizon.txt --clean_path Data/5_tax/subset_clean_index_10k.csv --task_name 5_tax_10k_ori --output_path results/horizon/ --index_attribute index --mse_attributes rate"
    #"python3 CleanerRunScript/run_horizon/run_horizon_base.py --dirty_path Data/6_soccer/subset_dirty_index_10k.csv --rule_path Data/6_soccer/dc_rules-validate-fd-horizon.txt --clean_path Data/6_soccer/subset_clean_index_10k.csv --task_name 6_soccer_10k_ori --output_path results/horizon/ --index_attribute index"
