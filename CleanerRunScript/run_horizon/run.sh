...
#    "python3 CleanerRunScript/run_horizon/run_horizon_base.py --dirty_path Data/1_hospitals/dirty_index.csv --rule_path Data/1_hospitals/dc_rules-validate-fd-horizon.txt --clean_path Data/1_hospitals/clean_index.csv --task_name 1_hospital_ori --output_path results/horizon/ --index_attribute index --mse_attributes Score"
    ...
    "python3 CleanerRunScript/run_horizon/run_horizon_base.py --dirty_path Data/5_tax/dirty_index.csv --rule_path Data/5_tax/dc_rules-validate-fd-horizon.txt --clean_path Data/5_tax/clean_index.csv --task_name 5_tax_200k_ori --output_path results/horizon/ --index_attribute index --mse_attributes rate"
#    "python3 CleanerRunScript/run_horizon/run_horizon_base.py --dirty_path Data/6_soccer/subset_directly_dirty_index_10k.csv --rule_path Data/6_soccer/dc_rules-validate-fd-horizon.txt --clean_path Data/6_soccer/subset_directly_clean_index_10k.csv --task_name 6_soccer_10k_ori --output_path results/horizon/ --index_attribute index"
#    "python CleanerRunScript/run_horizon/run_horizon_base.py --dirty_path Data/6_soccer/dirty_index.csv --rule_path Data/6_soccer/dc_rules-validate-fd-horizon.txt --clean_path Data/6_soccer/clean_index.csv --task_name 6_soccer_200k_ori --output_path results/horizon/ --index_attribute index"
)
...
#    "logs/1_hospital_ori_horizon.log"
    ...
    "logs/5_tax_200k_ori_horizon.log"
    #"logs/6_soccer_10k_ori_horizon.log"
#    "logs/6_soccer_200k_ori_horizon.log"
)
