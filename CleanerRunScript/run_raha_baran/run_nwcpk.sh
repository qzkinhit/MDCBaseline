...
datasets=(
    ...
    # "6_soccer:index::Data/6_soccer/subset_soccer_10k/noise_with_correct_primary_key:Data/6_soccer/subset_soccer_10k/subset_clean_index_10k.csv"
)

# 定义错误比例集合
# error_ratios=("0.25" "0.5" "0.75" "1" "1.25" "1.5" "1.75" "2")
error_ratios=("1.25" "1.5" "1.75" "2")
