...
commands=(
    ...
    "python CleanerRunScript/run_raha_baran/repair_with_raha.py --dirty_path Data/5_tax/subset_dirty_index_10k.csv --clean_path Data/5_tax/subset_clean_index_10k.csv --task_name 5_tax_10k_ori --output_path results/raha_baran/ --index_attribute index --mse_attributes rate"
    "python CleanerRunScript/run_raha_baran/repair_with_raha.py --dirty_path Data/6_soccer/subset_dirty_index_10k.csv --clean_path Data/6_soccer/subset_clean_index_10k.csv --task_name 6_soccer_10k_ori --output_path results/raha_baran/ --index_attribute index"
)
