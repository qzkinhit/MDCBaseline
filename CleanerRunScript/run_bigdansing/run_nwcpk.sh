...
bigdansing_commands=(
    ...
    "python3 CleanerRunScript/run_bigdansing/run_bigdansing_base.py --output_path results/bigdansing/nwcpk --clean_path Data/1_hospital/clean_index.csv --dirty_path Data/1_hospital/noise_with_correct_primary_key/dirty_mixed_1/dirty_hospitals_mix_1.csv --rule_path Data/1_hospital/dc_rules_dc_holoclean.txt --task_name 1_hospital_nwcpk_100 --mse_attributes Score"
    ...
    "python3 CleanerRunScript/run_bigdansing/run_bigdansing_base.py --output_path results/bigdansing/nwcpk --clean_path Data/1_hospital/clean_index.csv --dirty_path Data/1_hospital/noise_with_correct_primary_key/dirty_mixed_2/dirty_hospitals_mix_2.csv --rule_path Data/1_hospital/dc_rules_dc_holoclean.txt --task_name 1_hospital_nwcpk_200 --mse_attributes Score"
    ...
    "python3 CleanerRunScript/run_bigdansing/run_bigdansing_base.py --output_path results/bigdansing/nwcpk --clean_path Data/2_flights/clean_index.csv --dirty_path Data/2_flights/noise_with_correct_primary_key/dirty_mixed_0.5/dirty_hospitals_mix_0.5.csv --rule_path Data/2_flights/dc_rules_holoclean.txt --task_name 2_flights_nwcpk_050"
    ...
    "python3 CleanerRunScript/run_bigdansing/run_bigdansing_base.py --output_path results/bigdansing/nwcpk --clean_path Data/2_flights/clean_index.csv --dirty_path Data/2_flights/noise_with_correct_primary_key/dirty_mixed_2/dirty_hospitals_mix_2.csv --rule_path Data/2_flights/dc_rules_holoclean.txt --task_name 2_flights_nwcpk_200"
    ...
    "python3 CleanerRunScript/run_bigdansing/run_bigdansing_base.py --output_path results/bigdansing/nwcpk --clean_path Data/3_beers/clean_index.csv --dirty_path Data/3_beers/noise_with_correct_primary_key/dirty_mixed_0.5/dirty_hospitals_mix_0.5.csv --rule_path Data/3_beers/dc_rules_holoclean.txt --task_name 3_beers_nwcpk_050 --index_attribute id --mse_attributes abv ibu"
    ...
    "python3 CleanerRunScript/run_bigdansing/run_bigdansing_base.py --output_path results/bigdansing/nwcpk --clean_path Data/3_beers/clean_index.csv --dirty_path Data/3_beers/noise_with_correct_primary_key/dirty_mixed_1/dirty_hospitals_mix_1.csv --rule_path Data/3_beers/dc_rules_holoclean.txt --task_name 3_beers_nwcpk_100 --index_attribute id --mse_attributes abv ibu"
    ...
    "python3 CleanerRunScript/run_bigdansing/run_bigdansing_base.py --output_path results/bigdansing/nwcpk --clean_path Data/3_beers/clean_index.csv --dirty_path Data/3_beers/noise_with_correct_primary_key/dirty_mixed_1.5/dirty_hospitals_mix_1.5.csv --rule_path Data/3_beers/dc_rules_holoclean.txt --task_name 3_beers_nwcpk_150 --index_attribute id --mse_attributes abv ibu"
    ...
    "python3 CleanerRunScript/run_bigdansing/run_bigdansing_base.py --output_path results/bigdansing/nwcpk --clean_path Data/3_beers/clean_index.csv --dirty_path Data/3_beers/noise_with_correct_primary_key/dirty_mixed_2/dirty_hospitals_mix_2.csv --rule_path Data/3_beers/dc_rules_holoclean.txt --task_name 3_beers_nwcpk_200 --index_attribute id --mse_attributes abv ibu"
    ...
    "python3 CleanerRunScript/run_bigdansing/run_bigdansing_base.py --output_path results/bigdansing/nwcpk --clean_path Data/4_rayyan/clean_index.csv --dirty_path Data/4_rayyan/noise_with_correct_primary_key/dirty_mixed_2/dirty_hospitals_mix_2.csv --rule_path Data/4_rayyan/dc_rules_holoclean.txt --task_name 4_rayyan_nwcpk_200"
)
