...
commands=(
    ...
    "python3 CleanerRunScript/run_holistic/run_holistic_base.py --task_name 5_tax_ori --rule_path Data/5_tax/dc_rules_holoclean.txt --onlyed 0 --perfected 0 --dirty_path Data/5_tax/dirty_index_10k.csv --clean_path Data/5_tax/clean_index_10k.csv --output_path results/holistic --mse_attributes salary rate singleexemp marriedexemp childexemp"
    "python3 CleanerRunScript/run_holistic/run_holistic_base.py --task_name 6_soccer_ori --rule_path Data/6_soccer/dc_rules_holoclean.txt --onlyed 0 --perfected 0 --dirty_path Data/6_soccer/dirty_index.csv --clean_path Data/6_soccer/clean_index.csv --output_path results/holistic"
)
