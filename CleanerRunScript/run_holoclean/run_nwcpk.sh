...
#     "4_rayyan:index::Data/4_rayyan/noise_with_correct_primary_key:Data/4_rayyan/clean_index.csv:Data/4_rayyan/dc_rules_holoclean.txt"
    ...
    #  "6_soccer:index::Data/6_soccer/subset_directly_extract_soccer_5k/noise_with_correct_primary_key:Data/6_soccer/subset_directly_extract_soccer_5k/subset_directly_extract_soccer_5k_clean_index.csv:Data/6_soccer/dc_rules_holoclean.txt"
)
