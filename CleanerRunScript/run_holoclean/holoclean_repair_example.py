...
hc.load_data('hospital', 'D:/holoclean/testdata/hospital.csv')

hc.load_dcs('D:/holoclean/testdata/hospital_constraints.txt')
...
hc.evaluate(fpath='D:/holoclean/testdata/hospital_clean.csv',
            tid_col='tid',
            attr_col='attribute',
            val_col='correct_val')
