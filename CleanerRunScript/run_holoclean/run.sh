...
holoclean_commands=(
    "python3 CleanerRunScript/run_holoclean/run_holoclean_base.py --clean_path 'Data/1_hospital/clean_index.csv' --dirty_path 'Data/1_hospital/dirty_index.csv' --rule_path 'Data/1_hospital/dc_rules_dc_holoclean.txt' --task_name '1_hospital_ori' --output_path results/holoclean --mse_attributes 'Score'"
    ...
    "python3 CleanerRunScript/run_holoclean/run_holoclean_base.py --clean_path 'Data/5_tax/clean_index_10k.csv' --dirty_path 'Data/5_tax/dirty_index_10k.csv' --rule_path 'Data/5_tax/dc_rules_holoclean.txt' --task_name '5_tax_ori' --output_path results/holoclean --mse_attributes 'salary rate singleexemp marriedexemp childexemp'"
