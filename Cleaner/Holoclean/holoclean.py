...
class Session:
    ...
    #     return eval_report
    def evaluate(self, fpath, tid_col, attr_col, val_col, na_values=None, output_csv_path=None,attrubte_list=None,clean_data=None,index_attribute='index'):
        """
        evaluate generates an evaluation report with metrics (e.g. precision,
        recall) given a test set.
        ...
        if output_csv_path:
            self.eval_engine.export_cleaned_data_to_csv(output_csv_path,attrubte_list,clean_data=clean_data,index_col_name=index_attribute)
