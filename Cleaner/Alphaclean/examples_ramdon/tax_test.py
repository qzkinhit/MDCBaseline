...
def main():
    ...
    models1 = [OneDeterminedOne(["zip"], ["state"])]
    models2 = [OneDeterminedOne(["zip"], ["city"])]
    models3 = [OneDeterminedOne(["fname"], ["gender"])]
    models4 = [OneToOne(["areacode"], ["state"])]
    ...
    operation, output = solve_data(df, models1, config, "zip")
    operation, output = solve_data(output, models2, config, "zip")
    operation, output = solve_data(output, models3, config, "fname")
    operation, output = solve_data(output, models4, config, "areacode")
