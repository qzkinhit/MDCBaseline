...
class Date(Predicate):
    ...
    def __str__(self):
        return 'attr %s is Date,rule is %s' % (self.attr, self.pattern)
...
class Float(Predicate):
    ...
    def __str__(self):
        return 'attr %s is Float,range is %s' % (self.attr, str(self.range))
...
class Pattern(Predicate):
    ...
    def __str__(self):
        return 'attr %s is Pattern,rule is %s' % (self.attr, str(self.pattern))
